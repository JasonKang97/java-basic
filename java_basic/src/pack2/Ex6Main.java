...
public class Ex6Main {
	...
	public static void main(String[] args) {
		...
		System.out.println(my1 + " " + my2);	//하나의 객체변수(instance)

		System.out.println(my1.name + " " + my2.name);	//하나의 객체변수(instance)
		my1.name = "한국인";
		...
		System.out.println(localDate.hashCode() + " " + localDate.hashCode());
