	...
	private void dbProcess() {
		try {
			...
			*/
			...
			//stmt.executeUpdate(sqlinsert);	// select는 executeQuery 이외의 SQL은 executeUpdate 사용
			//stmt.executeUpdate("delete from sangdata where code=5");
			
			// 참고: insert, update, delete는 성공하면 성공한 레코드 수, 실패하면 0을 반환함. insert는 1개 아니면 실패이므로 1 또는 0을 반환.
			// 자료 수정
			/*
